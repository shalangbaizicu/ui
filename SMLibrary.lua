...
function Ripple(obj)
	spawn(function()
		...
		Ripple.ZIndex = 8
		Ripple.Image = "rbxassetid://95419006462847"
...
if theme == 'dark' then
    ...
    DTTransparency = 0.6
      ...
      DropShadow.Image = "rbxassetid://15733241841"
  ...
  Open.Image = Main.Visible and "rbxassetid://95419006462847" or "rbxassetid://95419006462847"
end)
      UIG.Parent = Open
      local window = {}
