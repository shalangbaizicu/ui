...
if theme == 'dark' then
    ...
    DTTransparency = 0.6
      ...
      DropShadow.Image = "rbxassetid://114886131092327"
...
Open.Active = true
Open.Draggable = true
Open.Image = "rbxassetid://96198886456416"
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and "rbxassetid://96198886456416" or "rbxassetid://96198886456416" --开关的图
end)
      UIG.Parent = Open
      local window = {}
        ...
        function tab.section(tab, name, TabVal)
          ...
          function section.Button(section, text, callback)
            ...
            Btn.MouseButton1Click:Connect(function()
                spawn(function()
                    local music=Instance.new("Sound");music.Parent=game.SoundService;music.SoundId="rbxassetid://4590657391";music.Volume=5;music.PlayOnRemove=true;music:Destroy()
                    Ripple(Btn)
                end)
                    local music=Instance.new("Sound");music.Parent=game.SoundService;music.SoundId="rbxassetid://4590657391";music.Volume=5;music.PlayOnRemove=true;music:Destroy()
                    spawn(callback)
